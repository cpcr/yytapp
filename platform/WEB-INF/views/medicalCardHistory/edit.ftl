...
<script type="text/javascript">
	function smt() {
		...
		$.ajax({
				url: '${basePath}/medicalCardHistory/save',
				...
				<ul class="user_list">
					<li class="list_line2">
						...
						<span class="user_list_input">
							<input name="name" maxlength="30" placeholder="请输入姓名" value="${entity.name}"/>
						</span>
					</li>
					<li class="list_line2">
						<div>身份证号</div>
						<span class="user_list_input">
							<input name="idNo" maxlength="18" placeholder="请输入身份证号码" value="${entity.idNo}"/>
						</span>
						</li>
					<li class="list_line2">
						<div>手机号</div>
						<span class="user_list_input">
							<input type="tel" name="mobileNo" maxlength="11" placeholder="请输入手机号码" value="${entity.mobileNo}"/>
						</span>
					</li>
					<li class="list_line2">
						<div>与本人关系</div> 
					...
					<li>
						<div>就诊卡</div>
						<span class="user_list_input">
							<input name="cardNo" maxlength="255" placeholder="请输入卡号" value="${entity.cardNo}"/>
					</span></li>
				</ul>
			</div>
