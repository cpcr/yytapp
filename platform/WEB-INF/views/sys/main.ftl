...
<frameset cols="230px,*"  frameborder="no" border="0" framespacing="0">
	  <frameset rows="120px,*"  frameborder="no" border="0" framespacing="0">
	       ...
	       <frame src="${basePath}/menu/showMenu" scrolling="No" name="leftBottomFrame" id="leftBottomFrame" />
	  </frameset>
	  <frameset>
	    <!--rows="54px,*"  <frame src="${basePath}menu/setting" name="rightTopFrame" id="rightTopFrame" />-->
