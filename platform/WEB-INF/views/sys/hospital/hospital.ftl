                            ...
                            <div class="control-group">
                            	...
                            	<div class="controls">
	                            	<select id="svcType" name="svcType">
	                            		<#if hospital?exists&&hospital.svcType=="1">
	                            			<option value="1" selected="selected">医院</option>
	                            		<#else>
	                            			<option value="1">医院</option>
	                            		</#if>
	                            		<#if hospital?exists&&hospital.svcType=="2">
