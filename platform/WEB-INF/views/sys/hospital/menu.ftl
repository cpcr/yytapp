                            ...
                            <form class="form-inline">
                                ...
                                <div class="my_select">
                                    ...
                                    <select id="platforms" onchange="getMeun(this)">
                            			<#if platformVo.id == platformsMap['wechat'].id>
                            				<option value="${platformsMap['wechat'].id}" code="${platformsMap['wechat'].code}" selected="selected">${platformsMap['wechat'].name}</option>
                            			<#else>
                            				<option value="${platformsMap['wechat'].id}" code="${platformsMap['wechat'].code}">${platformsMap['wechat'].name}</option>
                            			</#if>
                            			<#if platformVo.id == platformsMap['alipay'].id>
                            				<option value="${platformsMap['alipay'].id}" code="${platformsMap['alipay'].code}" selected="selected">${platformsMap['alipay'].name}</option>
                            			<#else>
                            				<option value="${platformsMap['alipay'].id}" code="${platformsMap['alipay'].code}">${platformsMap['alipay'].name}</option>
                            			</#if>
                            			<#if platformVo.id == platformsMap['easyHealth'].id>
                            				<option value="${platformsMap['easyHealth'].id}" code="${platformsMap['easyHealth'].code}" selected="selected">${platformsMap['easyHealth'].name}</option>
                            			<#else>
                            				<option value="${platformsMap['easyHealth'].id}" code="${platformsMap['easyHealth'].code}">${platformsMap['easyHealth'].name}</option>
                            			</#if>
                                    </select>
                                </div>
                            </form>
	                           							...
	                           							<select name="menuOptionalSelect" class="span12" onchange="changeSet(this)" flagTime="${menu.id}" >
	                           								...
	                           								<#if selHospitalOptionalsList?size>
	                           									<#list selHospitalOptionalsList as selHospitalOptionals>
		                           									...
		                           									<#else>
		                           										<#if selHospitalOptionals.optional.isEasyHealth == 1>
			                           										<#if menu.optionalId == selHospitalOptionals.optional.id>
			                           											<option value="${selHospitalOptionals.optional.id}" bizCode="${selHospitalOptionals.optional.bizCode}" selected="selected">${selHospitalOptionals.optional.name}</option>
			                           										<#else>
			                           											<option value="${selHospitalOptionals.optional.id}" bizCode="${selHospitalOptionals.optional.bizCode}">${selHospitalOptionals.optional.name}</option>
