...
<#include "./sys/common/hospital_setting.ftl">
    ...
    <div class="container-fluid">
        ...
        <div class="row-fluid">
            ...
            <div class="row-fluid">
                <div class="pull-left">
                    <button type="button" id="wechatLibrary" class="btn btn-ok w145 select" onclick="change(1)">微信模版库</button>
                    <button type="button" id="alipayLibrary" class="btn btn-ok w145" onclick="change(2)">支付宝模版库</button>
                    <button type="button" id="easyHealthLibrary" class="btn btn-ok w145" onclick="change(3)">健康易模版库</button>
                </div>
