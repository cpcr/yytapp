                ...
                <div class="widget-content form-check">
                    <div class="row-fluid">
                        <table class="table table-bordered table-textCenter table-striped table-hover" >
                            <tbody>
                                <tr>
                                    <td width="10%">微信支付缓存</td>
                                    <td width="88%">
                                        <textarea style="width:100%;height:350px;" class="textarea-pay" readonly="readonly">${wechat}</textarea>
                                    </td>
                                </tr>
                                <tr>
                                    <td width="10%">支付宝支付缓存</td>
                                    <td><textarea style="width:100%;height:350px;" class="textarea-pay" readonly="readonly">${alipay}</textarea></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
