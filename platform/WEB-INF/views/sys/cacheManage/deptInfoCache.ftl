                ...
                <div class="widget-content form-check">
                    <div class="row-fluid">
                        <table class="table table-bordered table-textCenter table-striped table-hover" >
                            <tbody>
                                <tr>
                                    <td width="10%">一级科室缓存</td>
                                    <td width="88%">
                                        <textarea style="width:100%;height:350px;" class="textarea-pay" readonly="readonly">${levelOneDepts}</textarea>
                                    </td>
                                </tr>
                                <#if levelTwoDepts?exists>
                                <tr>
                                    <td width="10%">二级科室缓存</td>
                                    <td>
                                        <textarea style="width:100%;height:350px;" class="textarea-pay" readonly="readonly">${levelTwoDepts}</textarea>
                                    </td>
                                </tr>
                                </#if>
