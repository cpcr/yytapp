...
<body>
	...
	<#setting datetime_format="yyyy-MM-dd HH:mm"/>
        ...
        <a href="${basePath}order/orderList?hospitalId=${hospitalId}">订单管理</a>
        &nbsp;&nbsp;绑卡管理
        </h3></div>
    </div>
            ...
            <div class="widget-box orderBox">
            	...
            	<form class="form-horizontal" method="post" action="${basePath}order/queryMedicalCard" accept-charset="utf-8">
            		...
            		<div class="row-fluid">
                        ...
                        <div class="control-group">
                            <label class="control-label">建卡时间</label>
                            <div class="controls">
        						...
        						<#if medicalCards?exists>
                                	<#list medicalCards as mc>
	                                	<tr onclick="clickHit(this)">
                                            ...
                                            <td>
												${mc.createTime?number_to_datetime}
													<#--<fmt:formatDate value="${mc.createTime}" pattern="yyyy-MM-dd HH:mm"/>-->
											</td>
		                                    <td>
		                                    	<#if mc.state == 1>
