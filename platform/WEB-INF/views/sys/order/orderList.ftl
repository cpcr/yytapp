...
<body>
    ...
    <div id="content-header">
        <div class="widget-title"><h3 class="title">
                订单管理
        &nbsp;&nbsp;<a href="${basePath}order/queryMedicalCard?hospitalId=${hospitalId}">绑卡管理</a>
        </h3></div>
    </div>
            	...
            	<form class="form-horizontal" method="post" action="${basePath}order/orderList" accept-charset="utf-8">
            		...
            		<div class="row-fluid">
						<table width="1000"><tr>
                            ...
                            <td width="110" <#if orderType == null || orderType == ''>style="display: none;"</#if>>
                                <label class="control-label">业务状态:</label>
							</td>
                            <td width="150" <#if orderType == null || orderType == ''>style="display: none;"</#if>>
