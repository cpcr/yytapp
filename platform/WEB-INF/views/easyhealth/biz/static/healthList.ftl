	...
	<ul id="health" class="flex-wrap col-flex" style="height: 100%">
        <li class="flex-wrap row-flex flexWidth3">
            <div class="flexWidth2">
                <div class="item" onclick="go('${basePath}easyhealth/healthlist/regrecord/index?openId=${sessionUser.id}&appCode=easyHealth&areaCode=ShenZheng', true);">
                    <div class="icon"><i class="iconfont greed">&#xe64c;</i></div>
                    <div class="label">就诊记录</div>
                </div>
            </div>
            <div class="flexWidth2">
                <div class="item" onclick="go('${basePath}easyhealth/healthlist/payment/index?openId=${sessionUser.id}&appCode=easyHealth&areaCode=ShenZheng', true);">
        ...
        <li class="flex-wrap row-flex flexWidth3">
            <div class="flexWidth2">
                <div class="item" onclick="go('${basePath}easyhealth/healthlist/regDoctor/index?openId=${sessionUser.id}&appCode=easyHealth&areaCode=ShenZheng', true);">
                    <div class="icon"><i class="iconfont yellow">&#xe648;</i></div>
                    <div class="label">医生记录</div>
                </div>
            </div>
            <div class="flexWidth2">
                <div class="item" onclick="go('${basePath}easyhealth/healthlist/reports/ehReportIndex?openId=${sessionUser.id}&appCode=easyHealth&areaCode=ShenZheng', true);">
                    <div class="icon"><i class="iconfont greed">&#xe649;</i></div>
        ...
        <li class="flex-wrap row-flex flexWidth3">
            ...
            <div class="flexWidth2">
                <div class="item">
                    <div class="icon"><img class="picThumb des" src="${basePath}easyhealth/images/icon9.png" width="50" height="50"/></div>
                </div>
            </div>
        </li>
    </ul>
