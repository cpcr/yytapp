...
<script type="text/javascript">
	...
	function doGoBack()
	{
		window.location.href="${basePath}easyhealth/communitycenter/communityHealth/getAdministrativeRegion?openId=${sessionUser.id}&appCode=easyHealth&areaCode=ShenZheng";
	}
</script>