...
<head>
	...
	<script type="text/javascript" src="${basePath}/easyhealth/js/common/nav-list.js?v=2"></script>
    <title>巡诊专家</title>
    <style>
    	.yx-list li{
		    display: -webkit-box;
...
function addOrganizaHtml(organizationList,indexSizeAdd){
	...
	if (organizationList.length > 0) {
	 $.each(organizationList, function(i, organization) {
		...
		sHtml+= '</span></div>';
        sHtml+= '<div class="pic"><img src="${basePath}easyhealth/images/touxiang.png"  width="65" height="65"/></div>';
