...
<div id="body" class="threemRange">
    ...
    <nav class="threemRange-nav" id="threemRange-menu" style="display:none;">
        ...
        <div class="threemRange-nav-item"  onclick="go('${basePath}easyhealth/communitycenter/communityHealth/getAdministrativeRegion?openId=${sessionUser.id}&appCode=easyHealth&areaCode=ShenZheng',1)" ><i>&#xe654;</i><span>社康</span></div>
