...
<div id="body">
    <div id="myCenter">
        ...
        <ul class="yx-list listRow" style=" background-color: #fff; ">
            ...
            <li class="arrow" onclick="go('${basePath}easyhealth/communitycenter/communityHealth/getCommunityOrganizaWeekDetail?openId=${sessionUser.id}&appCode=easyHealth&areaCode=ShenZheng',1)"><div class="u-img"><i class="iconfont i-green">&#xe648;</i></div> 巡诊专家 </li>
            <li class="arrow" onclick="go('${basePath}easyhealth/listindex/registerIndex?openId=${sessionUser.id}&appCode=easyHealth&areaCode=ShenZheng',1)"><div class="u-img"><i class="iconfont i-blue">&#xe647;</i></div> 我要挂号</li>
            <#--
            <li class="arrow" onclick="go('${basePath}easyhealth/building',1)"><div class="u-img"><i class="iconfont i-yellow">&#xe646;</i></div> 双向转诊 </li>
            <li class="arrow" onclick="go('http://minisite.www.yunyichina.cn/InHospital/Information/index?appid=wx95ac8639496452b8&app_id=10041',1)"><div class="u-img"><i class="iconfont i-green">&#xe645;</i></div> 健康宣教 </li>
