...
<div id="body">
	<div id="login-wrap">
	    <div class="loginBox">
	        <div class="thumbImg">
	            <div class="logo"><img src="${basePath}easyhealth/images/greenSkin/login/loginLogin.png" width="100" /> </div>
	        </div>
	        <div class="frm-box">
...
<script src="${basePath}easyhealth/js/biz/user/eh.login.js?v=1.1.2" type="text/javascript"></script>
</body>
</html>
