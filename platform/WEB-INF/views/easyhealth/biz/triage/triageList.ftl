              		...
              		<#list diseases as disease>
              			<div class="view-row">
			                ...
			                <div class="btn-box btn-w">
			                    ...
			                    <button type="button" class="btn btn-ok" onclick="go('${basePath}mobileApp/register/hospitalList?openId=${sessionUser.id}&appCode=easyHealth&areaCode=ShenZheng&regType=2',true);">去挂号</button>
			                </div>
			            </div>
              		</#list>
              	<#else>
