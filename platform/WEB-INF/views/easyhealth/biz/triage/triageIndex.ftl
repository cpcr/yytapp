...
<head>
    ...
    <script src="${basePath}easyhealth/js/biz/triage/eh.triage.js"></script>
    <title>智能分诊</title>
</head>
<body>
	<div id="body">
	        ...
	        <div class="triageList">
	            ...
	            <div class="search-nav">
	                <ul class="search-nav-ul">
	                    <li class="icon-hospital" onclick="go('${basePath}easyhealth/search/index?openId=${sessionUser.id}&appCode=easyHealth&areaCode=ShenZheng&searchType=hospital',1);">搜医院</li>
	                    <li class="icon-kesi" onclick="go('${basePath}easyhealth/search/index?openId=${sessionUser.id}&appCode=easyHealth&areaCode=ShenZheng&searchType=dept',1);">搜科室</li>
	                    <li class="icon-doctor" onclick="go('${basePath}easyhealth/search/index?openId=${sessionUser.id}&appCode=easyHealth&areaCode=ShenZheng&searchType=doctor',1);">搜医生</li>
