...
<div id="body">
    <div id="myCenter">
        ...
        <ul class="yx-list listRow">
            <li class="arrow" onclick="go('${basePath}mobileApp/customService/toFeedback?openId=${sessionUser.id}&type=2',true)"><div class="u-img"><i class="iconfont i-green">&#xe63f;</i></div>APP反馈</li>
