...
<div class="w1000">
            ...
            <div class="control-group">
                <div class="controls">
                    <div class="main_input_box">
                        ...
                        <input type="text" class="text-input" placeholder="请输入账户名" id="username"/>
                    </div>
                </div>
            </div>
            <div class="control-group">
                <div class="controls">
                    <div class="main_input_box">
                        ...
                        <input type="password" class="text-input" placeholder="请输入密码" id="password"/>
                    </div>
                </div>
            </div>
            <div class="control-group">
    ...
    <div id="Copyright">粤ICP备xxxxx号   Copyright©2014 云医通 AII Rights Reserved </div>
</div>
<script>
