...
<div id="body">
    ...
    <div class="page-select">
            ...
            <ul class="yx-list">
                ...
                <li>
                    ...
                    <div class="values">
	                    <div class="input-placeholder">
	                    	<span class="placeholder-text">请输入</span>
	                    	<input class="yx-input noBorder patAddress" type="text" id="selfAddress" maxlength="50"/>
	                    </div>
	                </div>
                </li>
            </ul>
	    ...
	    <div class="section btn-w">
	        <button class="btn btn-block" id="createSelf" onclick="createCard.createSelf(this);">确定</button>
	    </div>
    </div>
    <!--本人 end-->
    ...
    <div class="page-select">
            ...
            <ul class="yx-list">
                ...
                <li>
                    ...
                    <div class="values">
	                    <div class="input-placeholder">
	                    	<span class="placeholder-text">请输入</span>
	                    	<input class="yx-input noBorder patAddress" type="text" id="otherAddress" maxlength="50"/>
	                    </div>
	                </div>
                </li>
            </ul>
	    ...
	    <div class="section btn-w">
	        <button class="btn btn-block" id="createOther" onclick="createCard.createOther(this);">确定</button>
	    </div>
    </div>
    <!--他人 end-->
    ...
    <div class="page-select">
            ...
            <ul class="yx-list">
                ...
                <li>
                    ...
                    <div class="values">
	                    <div class="input-placeholder">
	                    	<span class="placeholder-text">请输入</span>
	                    	<input class="yx-input noBorder patAddress" type="text" id="childAddress" maxlength="50"/>
	                    </div>
	                </div>
                </li>
            </ul>
	    ...
	    <div class="section btn-w">
	        <button class="btn btn-block" id="createChild" onclick="createCard.createChild(this);">确定</button>
	    </div>
    </div>
    <!--儿童 end-->
</div>
...
<input type="hidden" name="onlineFilingTip" id="onlineFilingTip" value="${rule.onlineFilingTip?replace('\r\n', '&lt;br /&gt;')}" />
...
<script type="text/javascript" src="${basePath}mobileApp/js/biz/medicalcard/app.createCard.js?v=1.0"></script>
