        ...
        <div class="box-list fff">
            ...
            <div class="js-tagContent tagContent show">
                ...
                <ul class="yx-list userList">
                     ...
                     <li class="pic arrow" onclick="goVote('${entity.id}' ,'${entity.userId}' , '${entity.orderNo}' , '${entity.hospitalId}')">
            ...
            <div class="js-tagContent tagContent">
                ...
                <ul class="yx-list userList">
                    ...
                    <li class="pic arrow" onclick="toView('${entity.id}' ,'${entity.userId}' , '${entity.orderNo}', '${entity.hospitalId}')">
                        <div class="item-right">
...
function goVote(id ,userId ,orderNo ,hospitalId ){
	var url = appPath + "mobileApp/vote/toEdit?userId=" + userId + "&id=" + id + "&orderNo=" + orderNo + "&hospitalId=" + hospitalId;
...
function toView(id ,userId ,orderNo ,hospitalId){
	var url = appPath + "mobileApp/vote/toView?userId=" + userId + "&id=" + id + "&orderNo=" + orderNo + "&hospitalId=" + hospitalId;
	var appCode = '${commonParams.appCode}';
    if (appCode == 'easyHealth') {
		go(url, true);
	} else {
