...
function loadDoctorList(hookDate){
	...
	//加载当天的号源信息
	var url =  appPath + "/mobileApp/askDoctor/queryDoctorList?timeTemp=" + timeTemp;
	    ...
	    if(doctors){
	    	if(doctors.length > 0){
	    		for(var i = 0 ; i < doctors.length ; i++){
		            ...
		            htmlStr += "         <div>剩余<span class='skinColor fontSize120'>" + doctors[i].leftTotalNum + "</span>个号</div>"
		            htmlStr += "	</div>";
