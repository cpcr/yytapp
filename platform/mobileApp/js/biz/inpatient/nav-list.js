...
$(function(){
    $('#js-navList').on('click','li',function(){
        ...
        if(o.hasClass('js-item')){
            ...
            var admissionNo = o.attr('data-admissionNo');
            ...
            if (cardNo && cardType) {
            	...
            	$('#selectedCard').attr('data-admissionNo', admissionNo);
            ...
            if (typeof $.cookie == 'function') {
            	...
            	if (appId && openId && appId != 'null' && openId != 'null' && o.attr('userId')) {
            		console.log('写入cookies: ' + $('#appId').val() + '_' + $('#openId').val() + '_defaultCard=' + o.attr('userId'));
