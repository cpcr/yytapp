	...
	$.ajax({
		...
		success : function(data) {
			...
			$(data.list).each(function(i, n) {
				...
				if('客服'==n.msgType){
					tr.append("<td><a href='javascript:void(0);' onclick=\"window.location.href='" + msgCustomerUrl + "?id=" + n.id + "'\">编辑</a></td>");
				}else if('模板'==n.msgType){
					tr.append("<td><a href='javascript:void(0);' onclick=\"window.location.href='" + msgTemplateUrl + "?id=" + n.id + "'\">编辑</a></td>");
				}
			});
