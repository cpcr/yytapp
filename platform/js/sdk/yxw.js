/**
 * 微信公众账号&支付宝服务窗 JS SDK - 云医通 需基于JQuery,请在导入次JS文件之前导入JQuery
 * 
 * @version 1.0
 ...
 * 浏览器判断模块
 * 
 * @微信样例 Mozilla/5.0 (iPhone; CPU iPhone OS 8_1 like Mac OS X) AppleWebKit/600.1.4 (KHTML, like Gecko) Mobile/12B411 MicroMessenger/6.0 NetType/WIFI
 * @支付宝样例 Mozilla/5.0 (iPhone; CPU iPhone OS 8_1_3 like Mac OS X) AppleWebKit/600.1.4 (KHTML, like Gecko) Mobile/12B466 PSDType(1) AliApp(AP/8.5.3.012402) AlipayClient/8.5.3.012402
 */
